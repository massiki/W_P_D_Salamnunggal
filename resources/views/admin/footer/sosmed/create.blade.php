          ...
          <div class="col-md-12">
            <div class="card card-outline card-info">
              <div class="card-header">
                <h3 class="card-title">Buat Sosial Media</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ route('admin.sosmed.store') }}" method="post">
                  ...
                  <div class="form-group">
                    <label for="value">Value (masukan link jika typenya URL, masuk nomor jika typenya phone)</label>
                    <input type="text" name="value" class="form-control" id="value"
                      placeholder="Masukan value . . ." value="{{ old('value') }}">
                    @error('value')
                      <p class="text-danger">{{ $message }}</p>
                    @enderror
                  </div>
                  <div class="form-group">
                    <button type="submit" class="btn btn-primary">Buat Sosmed</button>
                  </div>
                </form>
              </div>
            </div>
