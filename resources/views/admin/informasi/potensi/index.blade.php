      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
                  ...
                  <tbody>
                    @forelse ($potensi as $data)
                      <tr>
                        ...
                        <td>
                          <a href="{{ route('admin.potensi.edit', $data->id) }}" class="btn btn-warning my-1"><i
                              class="fas fa-pencil-alt"></i></a>
                          <form action="{{ route('admin.potensi.destroy', $data->id) }}" method="post"
                    ...
                    @empty
                      <tr>
                        <td colspan="5" class="text-center">Potensi tidak ditemukan</td>
                      </tr>
                    @endforelse
                  </tbody>
                </table>
            ...
            {{ $potensi->links('pagination::bootstrap-5') }}
            <!-- /.card -->
          </div>
        </div>
        <!-- /.row -->
