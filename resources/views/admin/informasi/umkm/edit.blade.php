                ...
                <form action="{{ route('admin.umkm.update', $data->id) }}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="nama_pemilik" class="form-control" id="nama_pemilik"
                      placeholder="Masukan nama pemilik . . ." value="{{ old('nama_pemilik', $data->nama_pemilik) }}">
                    @error('nama_pemilik')
                      <p class="text-danger">{{ $message }}</p>
                    @enderror
                  </div>
                  <div class="form-group">
                    ...
                    <input type="text" name="jenis_umkm" class="form-control" id="jenis_umkm"
                      placeholder="Masukan jenis UMKM . . ." value="{{ old('jenis_umkm', $data->jenis_umkm) }}">
                    @error('jenis_umkm')
                      <p class="text-danger">{{ $message }}</p>
                    @enderror
                  </div>
                  <div class="form-group">
                    ...
                    <input type="text" name="no_whatsapp" class="form-control" id="no_whatsapp" inputmode="numeric"
                      ...
                      value="{{ old('no_whatsapp', $data->no_whatsapp) }}">
                    @error('no_whatsapp')
                      <p class="text-danger">{{ $message }}</p>
                    @enderror
                  </div>
                  <div class="form-group">
                    ...
                    <input type="text" name="harga" class="form-control" id="harga" inputmode="numeric"
                      oninput="inputHarga()" placeholder="Masukan harga . . ." value="{{ old('harga', $data->harga) }}">
                    @error('harga')
                      <p class="text-danger">{{ $message }}</p>
                    @enderror
                  </div>
                  <div class="form-group">
                    ...
                    <input type="text" name="instagram" class="form-control" id="instagram"
                      placeholder="Masukan link instagarm . . ." value="{{ old('instagram', $data->instagram) }}">
                    @error('instagram')
                      <p class="text-danger">{{ $message }}</p>
                    @enderror
                  </div>
                  <div class="form-group">
                    ...
                    <input type="text" name="shopee" class="form-control" id="shopee"
                      placeholder="Masukan link shopee . . ." value="{{ old('shopee', $data->shopee) }}">
                    @error('shopee')
                      <p class="text-danger">{{ $message }}</p>
                    @enderror
                  </div>
                  <div class="form-group">
                    ...
                    <input type="text" name="tiktok" class="form-control" id="tiktok"
                      placeholder="Masukan link tiktok . . ." value="{{ old('tiktok', $data->tiktok) }}">
                    @error('tiktok')
                      <p class="text-danger">{{ $message }}</p>
                    @enderror
                  </div>
                  <div class="form-group">
                    ...
                    <input type="text" name="alamat" class="form-control" id="alamat"
                      placeholder="Masukan alamat . . ." value="{{ old('alamat', $data->alamat) }}">
                    @error('alamat')
                      <p class="text-danger">{{ $message }}</p>
                    @enderror
                  </div>
